...
import { QueryDetailWrapper } from '../../../components/gql/QueryDetailWrapper';
...
export default withApollo(function CourseDetail() {
  ...
  return (
    <QueryDetailWrapper<Demonstrate, 'api_demonstrate', 'update', 'demonId'>
      id={id}
      ...
      render={({ detail, loading, error, refetch, updatePart }) => (
        <Card
          {...holderCardProp}
          title="编辑演示内容详情"
          extra={
